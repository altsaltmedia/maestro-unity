...
namespace AltSalt
{
    ...
    [TrackClipType(typeof(FadePlayAudioVolumeClip))]
    [TrackBindingType(typeof(AudioSource))]
    public class FadePlayAudioVolumeTrack : LerpToTargetTrack
    {
        public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
        {
            StoreClipStartEndTime();
            return ScriptPlayable<FadePlayAudioVolumeMixerBehaviour>.Create (graph, inputCount);
        }
