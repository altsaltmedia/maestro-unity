...
namespace AltSalt
{    
    public class AxisSwitchTriggerMixerBehaviour : PlayableBehaviour
    {
        ...
        ScriptPlayable<AxisSwitchTriggerBehaviour> inputPlayable;
        AxisSwitchTriggerBehaviour input;
        ...
        {   
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                inputPlayable = (ScriptPlayable<AxisSwitchTriggerBehaviour>)playable.GetInput(i);
                input = inputPlayable.GetBehaviour ();

                if (input.switchType == SwitchType.AxisSwitch && input.axisSwitch != null) {
