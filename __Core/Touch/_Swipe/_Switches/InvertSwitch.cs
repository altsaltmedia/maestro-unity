...
namespace AltSalt
{   
    public class InvertSwitch : AxisSwitch
    {
            ...
            switch(switchType) {
                case "Activate Y Invert":
                    if(invertAxis.Value == false) {
						if (parentClip.currentTime >= (axisInflectionPoint.Value - invertTransitionSpread.Value)
						    && parentClip.currentTime < axisInflectionPoint.Value) {
                        ...
                        if (parentClip.currentTime < (axisInflectionPoint.Value - invertTransitionSpread.Value)
                           && parentClip.currentTime >= (axisInflectionPoint.Value - invertTransitionSpread.Value * 2)) {
