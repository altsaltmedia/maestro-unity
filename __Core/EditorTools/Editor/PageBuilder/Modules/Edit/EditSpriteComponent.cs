...
namespace AltSalt
{
    public class EditSpriteComponent : ChildUIElementsWindow
    {
        static PageBuilderWindow pageBuilderWindow;
        static Foldout windowUXML;
        ...
        public override ChildUIElementsWindow Init(EditorWindow parentWindow)
        {
            ...
            windowUXML = parentVisualElement.Query<Foldout>("EditSpriteComponent", EditorToolsCore.ToggleableGroup);

            var propertyFields = windowUXML.Query<PropertyField>();
            propertyFields.ForEach(SetupPropertyField);

            var buttons = windowUXML.Query<Button>();
        ...
        void UpdateDisplay()
        {
            ...
            windowUXML.SetEnabled(dependencySelected);
            windowUXML.value = dependencySelected;
        }
