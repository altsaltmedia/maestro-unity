...
namespace AltSalt.Sequencing.Touch
{
    public partial class AxisModifier
    {
        public partial class ForkSwitch
        {
            ...
            private static BranchingPath UpdateBranchSibling(BranchingPathSwitchData targetBranch, BranchType newBranchType, SequenceUpdateType updateType)
            {
                ...
                if (updateType == SequenceUpdateType.Next) {
                    targetBranch.touchData.sequence.syncer.SetNextSequenceGroup(branchDictionary[newBranchType].sequence,
                        branchDictionary[newBranchType].directorObject,
                        branchDictionary[newBranchType].isOrigin);
                } else {
                    targetBranch.touchData.sequence.syncer.SetPreviousSequenceGroup(branchDictionary[newBranchType].sequence,
                        branchDictionary[newBranchType].directorObject,
                        branchDictionary[newBranchType].isOrigin);
                }
