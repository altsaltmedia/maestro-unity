    ...
    public class Autoplayer : AutorunModule
    {
        ...
        protected virtual void Update()
        {
            ...
            for (int q = 0; q < autorunController.autorunData.Count; q++)
            {
                ...
                AutoplaySequence(autorunController.applyInputToSequence, this, autorunData.sequence, autoplayModifer);
            
                if (autorunData.sequence.currentTime > currentInterval.endTime)  {
