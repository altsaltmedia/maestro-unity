...
namespace AltSalt.Sequencing.Touch
{
    ...
    public static class AxisModifier_ForkSwitchLegacy2
    {
//        enum SequenceUpdateType { Next, Previous }
//
//        public static AxisModifier_ForkExtents ActivateSwitch(double masterTime, AxisModifier_ForkExtents touchForkExtents)
//        {
...
//                    ActivateXBranch(touchForkExtents, activeBranch);
//                } else if (Mathf.Abs(swipeForce.x) > Mathf.Abs(swipeForce.y)) {
//                    ActivateYBranch(touchForkExtents, activeBranch);
//                }
//                    
//            }
//                
...
//            else {
//                                                
//                ResetBranchStates(touchForkExtents, new[] { BranchType.yPos, BranchType.yNeg, BranchType.xPos, BranchType.xNeg });
//
