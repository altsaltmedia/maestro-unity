        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            for (int i = 0; i < inputCount; i++) {
                ...
                if (input.crossfade == true) {
                    ...
                    float weightModifier = CrossfadeAudio(i, input, inputWeight, percentageComplete, trackAssetConfig.currentTime);
                    ...
                    float weightModifier = BlendSnapshots(i, input, inputWeight, percentageComplete, trackAssetConfig.currentTime);
