...
namespace AltSalt.Maestro.Animation
{
    ...
    public class TMProCharSpacingTrack : LerpToTargetTrack
    {
        public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
        {
            ...
            ScriptPlayable<TMProCharSpacingMixerBehaviour> trackPlayable = ScriptPlayable<TMProCharSpacingMixerBehaviour>.Create(graph, inputCount);
            TMProCharSpacingMixerBehaviour behaviour = trackPlayable.GetBehaviour();
