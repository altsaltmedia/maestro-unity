...
{
    public class EditFloatVarClip : ChildModuleWindow
    {
        protected override ChildModuleWindow Configure(ParentModuleWindow parentModuleWindow, string childRootUXMLName)
        {
            ...
            moduleChildUXML = parentModuleWindow.moduleWindowUXML.Query<Foldout>("EditFloatVarClip", EditorToolsCore.ToggleableGroup);
